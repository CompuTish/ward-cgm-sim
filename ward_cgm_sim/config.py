...
class AlarmConfig:
    ...
    # Modelling definitions chosen for this simulation. They are not clinical
    # standards and carry no external authority. They are configurable so a
    # researcher can substitute whatever definitions their own protocol uses.
    ...
    # *event* rather than a transient dip: three 5-minute steps. A configurable
    # model definition chosen for this simulation, with no external authority.
